...
```javascript
scabs1 = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-scabs1@v0.0.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-scabs1@v0.0.3-umd/browser.js"></script>
```
